...
from app.api.categories import router as categories_router, get_db as categories_get_db
from app.api.products import router as products_router, get_db as products_get_db
